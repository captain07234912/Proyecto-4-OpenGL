...
class Model(object):
    def __init__(self, fileName=None, textureName=None, escala=(1,1,1), posicion=(0,0,0)):
...
class Renderer(object):
    ...
    def render(self):
        ...
        if self.active_shader:
            ...
            glUniform1f(glGetUniformLocation(self.active_shader, "ambiente"), 0.5)

        self.modelList[self.modeloAct].rotarPitch(self.rotation.x)
        self.modelList[self.modeloAct].rotarYaw(self.rotation.y)
        self.modelList[self.modeloAct].rotarRoll(self.rotation.z)
